...
export default function Reservations() {
  return (
    <div className="ml-24 mt-16 w-[65%] ">
      <div className="flex items-center w-full">
        <h3 className="text-sm font-medium w-[57%]">Reservations</h3>
        <div className="flex items-center gap-5">
          <div className="flex items-center bg-[#E83E8C] px-5 gap-2 py-2 rounded-xl ">
            <FaFileCirclePlus className="h-5 text-white" />
            <button className=" rounded-lg border-none text-white text-xs font-semibold text-center ">
              Create Reservation
            </button>
          </div>
          {/* VIew all  */}
